...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/24 21:38:55 by mcourtoi          #+#    #+#             */
/*   Updated: 2023/04/24 21:42:12 by mcourtoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static inline char	*ft_strnchr(char *const str, char const c, size_t const n)
{
	size_t	i;
